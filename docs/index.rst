.. UECda-PyClient documentation master file, created by
   sphinx-quickstart on Fri Oct  7 17:02:01 2016.
...
* `UECda-PyClient <https://github.com/Hironsan/uecda-pyclient>`_
...
Installation
==================
UECda-PyClientを動かすために必要なライブラリをインストールします。
...
Documentation
==================
提供するAPIについて、ドキュメンテーション文字列から自動生成した内容のリンクを張る。
